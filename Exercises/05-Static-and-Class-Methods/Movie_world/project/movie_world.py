...
from Static_and_Class_Methods.Movie_world.project.customer import Customer
from Static_and_Class_Methods.Movie_world.project.dvd import DVD
...
class TestsMovieWorld(unittest.TestCase):
    ...
    def test_movie_world_rent_dvd_success(self):
        ...
        self.assertTrue(d.is_rented)
        self.assertEqual(c.rented_dvds, [d])
